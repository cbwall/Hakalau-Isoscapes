...
HKP.data$low.age<-HKP.data$DBH.Total*0.7
HKP.data$high.age<-HKP.data$DBH.Total*1.5

#### box plot of mutli-trunks, at 7 mm/y
multi.trunk.lowage<-ggplot(HKP.data, aes(y=low.age, x=Plot, fill=Plot)) + 
  geom_boxplot(outlier.shape = NA, alpha=0.6)+
  geom_point(pch = 21, position = position_jitterdodge(), alpha=0.6) +
  xlab("Plots") +
...
age.m<-aggregate(age~Plot, data=HKP.data, mean)
age.sd<-aggregate(age~Plot, data=HKP.data, sd)

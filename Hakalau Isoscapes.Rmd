...
Plants samples were collected in a spatially explicit fashion (every 4 or 5m) with a 20 x 35m superplot, consisting of thirty-five 4 x 5m subplots. This data was used to create a δ^13^C and δ^15^N stable isotope landscapes, hereafter 'isoscapes'. Koa and *Rubus* spp. were collected within each 4 x 5m subplot.  
  
**Plot densities were...**   
KP: Koa (18 trees) *Rubus* sp (14 plants) per 20 x 35m plot= 257 Koa and 200 *Rubus* per hectare*  
RK: Koa (10 trees) *Rubus* sp. (28 plants) per 20 x 35m plot= 142 Koa and 400 *Rubus* per hectare*  
...
#### note C:N ratios are calculated from %C and %N, not molar ratios
...
par(mfrow=c(1,2))
soil.d15N.isoscape<-gridExtra::grid.arrange(plotd15N.krig.KP.soil, plotd15N.krig.RK.soil, ncol=2, nrow=1, widths = c(1.22,1))
soil.d15N.isoscape
...
par(mfrow=c(1,2))
gridExtra::grid.arrange(plotd13C.krig.KP.soil, plotd13C.krig.RK.soil, ncol=2, nrow=1, widths = c(1.22,1)) 
...
### combined KP-Rk krig d15N plot 
par(mfrow=c(1,2))
gridExtra::grid.arrange(plotd15N.krig.KP.plants, plotd15N.krig.RK.plants, ncol=2, nrow=1, widths = c(1.22,1))

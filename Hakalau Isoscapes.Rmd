...
# Mann-Whitney U-Test
mwu(HAK.data, alt.age, Plot) # signif, p=0.010
```
...
# autokrige with nugget, range and sill 
d15N.RK.soil <- autoKrige(d15N ~ 1, RK.soil, fix.values = c(0,NA,1.2), Grid.RK) # ordinary kriging

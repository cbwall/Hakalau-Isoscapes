...
AK.Koa.df.betneg1<- AK.Koa.df %>%
  ...
  mutate(nfix.AK.av = (AK.R.av - d15N)/(AK.R.av-Beta.neg1)*100)
...
RK.Koa.df.betneg1<- RK.Koa.df %>%
  ...
  mutate(nfix.RK.av = (RK.R.av - d15N)/(RK.R.av-Beta.neg1)*100)
...
# build empty plot
plot(data=AK.Koa.df.betneg1, d15N~nfix.AK.max, yaxt="n", xaxt="n", ylim=c(-2,3), xlim=c(100, -30), 
     xlab="", ylab="", type="n")
...
plot(data=AK.Koa.df.betneg1, d15N~nfix.AK.max, col="salmon", xlab="Ndf-koa (%)",
     ...
     ylim=c(-2,3), xlim=c(100, -30), cex=0.7, pch=20)
...
# AK 
par(new=T)
plot(data=AK.Koa.df.betneg1, d15N~nfix.AK.av, col="salmon", xlab="", ylab= "", xaxt="n", yaxt="n",
     ylim=c(-2,3), xlim=c(100, -30), cex=0.7, pch=20)

#RK
par(new=T)
plot(data=RK.Koa.df.betneg1, d15N~nfix.RK.av, col="lightseagreen", xlab="", ylab= "", xaxt="n", yaxt="n",
     ylim=c(-2,3), xlim=c(100, -30), cex=0.7, pch=20)

# model
B1.mod.AKoa.av<-lm(d15N~nfix.AK.av, data=AK.Koa.df.betneg1)
B1.mod.RKoa.av<-lm(d15N~nfix.RK.av, data=RK.Koa.df.betneg1)

# add model lines
abline(B1.mod.AKoa.av, col="coral", lty=2)
abline(B1.mod.RKoa.av, col="darkcyan", lty=2)
...
plot(data=RK.Koa.df.betneg1, d15N~nfix.RK.med, col="lightseagreen", xlab="", ylab= "", xaxt="n", yaxt="n",
     ylim=c(-2,3), xlim=c(100, -30), cex=0.7, pch=20)
legend("bottomright", legend= c("max", "mean", "median"), bg="transparent",
       col="black", lty=c(1,2,4), 
       pch=20, cex=0.7, box.lty=0)
...
AK.Koa.df.betneg2<- AK.Koa.df %>%
  ...
  mutate(nfix.AK.av = (AK.R.av - d15N)/(AK.R.av-Beta.neg2)*100)
...
RK.Koa.df.betneg2<- RK.Koa.df %>%
  ...
  mutate(nfix.RK.av = (RK.R.av - d15N)/(RK.R.av-Beta.neg2)*100)


## Max

# build empty plot
plot(data=AK.Koa.df.betneg2, d15N~nfix.AK.max, yaxt="n", xaxt="n", ylim=c(-2,3), xlim=c(100, -30), 
     xlab="", ylab="", type="n")
...
# models (Max)
B2.mod.AKoa.max<-lm(d15N~nfix.AK.max, data=AK.Koa.df.betneg2) 
B2.mod.RKoa.max<-lm(d15N~nfix.RK.max, data=RK.Koa.df.betneg2)

# models (Median)
B2.mod.AKoa.med<-lm(d15N~nfix.AK.med, data=AK.Koa.df.betneg2)
B2.mod.RKoa.med<-lm(d15N~nfix.RK.med, data=RK.Koa.df.betneg2)

par(new=T)

#for AK
x <- seq(-40,100, 1) # sequence
ymax.AK <- x*(B2.mod.AKoa.max$coefficients[2])+B2.mod.AKoa.max$coefficients[1] # x*slope + intercept
ymed.AK <- x*(B2.mod.AKoa.med$coefficients[2])+B2.mod.AKoa.med$coefficients[1]
polygon(c(rev(x), x),c(rev(ymax.AK), ymed.AK),col=adjustcolor("salmon",alpha.f=0.2), border=NA)

#for RK
ymax.RK <- x*(B2.mod.RKoa.max$coefficients[2])+B2.mod.RKoa.max$coefficients[1] # x*slope + intercept
ymed.RK <- x*(B2.mod.RKoa.med$coefficients[2])+B2.mod.RKoa.med$coefficients[1]
polygon(c(rev(x), x),c(rev(ymax.RK), ymed.RK),col=adjustcolor("lightseagreen",alpha.f=0.2), border=NA)
...
plot(data=AK.Koa.df.betneg2, d15N~nfix.AK.max, col="salmon", xlab="Ndf-koa (%)",
     ylab= expression(paste(delta^{15}, N, " (\u2030)")), cex.axis=0.7, main= "Beta = -2", cex.main=0.7,
     ylim=c(-2,3), xlim=c(100, -30), cex=0.7, pch=20)
...
# add model lines
abline(B2.mod.AKoa.max, col="coral", lty=1)
abline(B2.mod.RKoa.max, col="darkcyan", lty=1)

## Mean
# AK 
par(new=T)
plot(data=AK.Koa.df.betneg2, d15N~nfix.AK.av, col="salmon", xlab="", ylab= "", xaxt="n", yaxt="n",
     ylim=c(-2,3), xlim=c(100, -30), cex=0.7, pch=20)

#RK
par(new=T)
plot(data=RK.Koa.df.betneg2, d15N~nfix.RK.av, col="lightseagreen", xlab="", ylab= "", xaxt="n", yaxt="n",
     ylim=c(-2,3), xlim=c(100, -30), cex=0.7, pch=20)

# model
B2.mod.AKoa.av<-lm(d15N~nfix.AK.av, data=AK.Koa.df.betneg2)
B2.mod.RKoa.av<-lm(d15N~nfix.RK.av, data=RK.Koa.df.betneg2)

# add model lines
abline(B2.mod.AKoa.av, col="coral", lty=2)
abline(B2.mod.RKoa.av, col="darkcyan", lty=2)
...
# add model lines
abline(B2.mod.AKoa.med, col="coral", lty=4)
abline(B2.mod.RKoa.med, col="darkcyan", lty=4)

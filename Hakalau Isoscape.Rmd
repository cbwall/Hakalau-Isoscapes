...
```{r Beta Ndfa}
# Beta and Ndfa
# need to calculate externally? 
# what are we tryin to do here?
# ability for Koa to fix, OR the relationship between d15N koa and Rubus?
# Koa as the reference plant, Or Rubus as reference plant?

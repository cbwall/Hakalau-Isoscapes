...
# inspect model
plot(pred.AK.plants.df.N$krige_output.var1.pred ~ pred.AK.plants.df.N$d15N, xlab = "Observed", ylab = "Predicted", cex=0.2)
abline(0,1, lty=2)
abline(mod, col = "blue")
...
# inspect model
plot(pred.RK.plants.df.N$krige_output.var1.pred ~ pred.RK.plants.df.N$d15N, xlab = "Observed", ylab = "Predicted", cex=0.2)
abline(0,1, lty=2)
abline(mod, col = "blue")
